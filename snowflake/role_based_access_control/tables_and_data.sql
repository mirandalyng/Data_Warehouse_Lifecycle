-- USE ICE CREAM WRITER TO OPERATE THE DATA 
...
-- USE SYSADMIN TO DROP THE TABLE BECAUSE IT'S WRONG 
USE ROLE SYSADMIN; 

-- WONT WORK BECAUSE ADMIN CANT DELETE TABLE 
DROP TABLE SUPPLIERS; 


-- INSERT DATA ROWS INTO TABLES 
